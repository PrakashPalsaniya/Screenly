...
export const featuredMovieSlides = allMovies.slice(0, 5).map((movie, index) => ({
  id: movie.id,
  title: movie.title,
  image: movie.img,
  rating: movie.rating,
...
export const movieCredits = {
  "Maa": {
    ...
    crew: [
      { role: "Director", name: "Vishal Furia" },
      { role: "Writer", name: "Saiwyn Quadras" },
      { role: "Music", name: "Harsh Upadhyay" },
    ],
  },
  "Kannappa": {
    cast: ["Vishnu Manchu", "Prabhas", "Mohanlal", "Kajal Aggarwal"],
    crew: [
      { role: "Director", name: "Mukesh Kumar Singh" },
      { role: "Writer", name: "Vishnu Manchu" },
      { role: "Music", name: "Stephen Devassy" },
    ],
  },
  "Mission: Impossible - The Final Reckoning": {
    cast: ["Tom Cruise", "Hayley Atwell", "Simon Pegg", "Ving Rhames"],
    crew: [
      { role: "Director", name: "Christopher McQuarrie" },
      { role: "Writer", name: "Christopher McQuarrie" },
  ...
  "From the World of John Wick: Ballerina": {
    ...
    crew: [
      { role: "Director", name: "Len Wiseman" },
      { role: "Writer", name: "Shay Hatten" },
      { role: "Studio", name: "Lionsgate" },
    ],
  },
  "M3GAN 2.0": {
    cast: ["Allison Williams", "Violet McGraw", "Amie Donald", "Jenna Davis"],
    crew: [
      { role: "Director", name: "Gerard Johnstone" },
      { role: "Writer", name: "Akela Cooper" },
      { role: "Producer", name: "James Wan" },
    ],
  },
  "Sitaare Zameen Par": {
    cast: ["Aamir Khan", "Genelia Deshmukh", "Darsheel Safary", "Brijendra Kala"],
    crew: [
      { role: "Director", name: "R. S. Prasanna" },
      { role: "Writer", name: "Divy Nidhi Sharma" },
      { role: "Music", name: "Shankar-Ehsaan-Loy" },
    ],
  },
};
